...
// Inisialisasi aplikasi Firebase dan referensi database
...
// Fungsi untuk menampilkan ketersediaan materi
function showMateriAvailability(userData) {
    ...
    const materis = [
        ...
        { key: 'quizakhir', label: 'Evaluasi Akhir (Final Test)', progressKey: 'quizakhir', link: 'final-test.html' }
    ];
